...
const uint8_t rook_bitmap[] PROGMEM = {
  0x00, 0x00,         // 0111 1111   1111 1110
  0x1f, 0xf0,        //  1111 1110   0111 1111
  0x3C, 0x78,        // 00111110    00111110
  0x38, 0x38,        // 00111110   01111111
  0x33, 0x98,        // 00111110   01111111
  0x33, 0x98,        // 00111110   01111111
  0x33, 0x98,        // 00111110   01111111
  0x30, 0x18,        // 00111110   01111111
  0x30, 0x38,        // 00111110   01111111
  0x30, 0xF8,        // 00111110   01111111
  0x33, 0xF8,        // 00111110   01111111
  0x33, 0xD8,        // 00111110   01111111
  0x38, 0x18,        // 00111110   01111111
  0x3C, 0x38,        // 00111110   01111111
  0x3F, 0xF8,        // 00111110   01111111
  0x1F, 0xF0        // 00111110   01111111
...
void loop(void) {
  ...
  do {
    draw();
    u8g.drawCircle(60, 18 + 30, 9);
    u8g.drawCircle(70, 18 + 30, 9);
    u8g.drawBitmapP( 0, 15, 2, 16, rook_bitmap);
  } while ( u8g.nextPage() );
