...
//
// Connect Arduino's RX pin to BY8001's TX pin 4
// Connect Arduino's TX pin to BY8001's RX pin 12
//
...
void setup(){
  ...
  int by8001_VolumeSetting = 29; //  Set volume to 15 (0-30 range) if not already set
